          ...
          <div className="relative mx-4">
            ...
            <div className="absolute z-10 top-0 left-0 mx-4 sm:mx-0 mt-36 sm:mt-0 sm:py-20 md:py-28 lg:py-20 xl:py-28 sm:pl-14 flex flex-col sm:justify-start items-start">
              ...
              <p className="text-base leading-normal text-white mt-4 sm:mt-5 sm:w-5/12">
                A bike is a human-powered or motor-powered, pedal-driven, single-track vehicle, having two wheels attached to a frame, one behind the other.
              </p>
              <button className="hidden sm:flex bg-yellow-500 rounded-lg py-4 px-8 text-base font-medium text-white mt-8 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 hover:bg-gray-700">
                Explore
              </button>
            </div>
