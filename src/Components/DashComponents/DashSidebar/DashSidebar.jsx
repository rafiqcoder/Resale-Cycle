      ...
      <div className="flex flex-col sm:w-64 flex-1  sm:flex-none h-screen py-8 bg-blue-200 border-r dark:bg-gray-900 dark:border-gray-700">
        ...
        <div className="flex flex-col justify-between flex-1 mt-6 w-full">
          <nav>
            ...
            <Link className="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700">
              <svg
                className="w-5 h-5"
                viewBox="0 0 24 24"
                fill="none"
